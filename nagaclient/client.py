...
def on_connect(client, userdata, rc):
    ...
    client.subscribe('naga/clients/{}/#'.format(client._client_id))
...
class NagaClient:
    ...
    def reconnect(self):
        ...
        #self.mqtt_client.subscribe('naga/clients/#')
    ...
    def register_callback(self):
        if self._rpc_server:
            ...
            self.mqtt_client.message_callback_add('naga/clients/'+self.client_id+'/response',
...
#        print('topic:', topic,'publish:', payload,)
    ...
    def call(self, method, args=None):
        ...
        self.publish('naga/clients/request', request, 1)
